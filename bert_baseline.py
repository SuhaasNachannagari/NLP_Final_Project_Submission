...
plt.legend()
plt.grid(True)
plt.savefig('bert_baseline_loss.png', dpi=150, bbox_inches='tight')
print("Loss plot saved to bert_baseline_loss.png")
...
plt.savefig('bert_baseline_confusion.png', dpi=150, bbox_inches='tight')
print("Confusion matrix saved to bert_baseline_confusion.png")